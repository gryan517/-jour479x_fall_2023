...
#i need to isolate the first four dates and i think i would do so by creating some sort of range. I tried doing: date (dates here,  but i received an error. also head automatically brings the amount of rows down to 6. 
```
...
#i've isolated the ties, but now i'm trying to figure out a way to bring together the amount of ties by team.
```
