...
```
Results: We still reject the null hypothesis in the early part of the season last year compared to where womens soccer is this season. The scoring for womens soccer is more this season  than scoring for last season at this point in the season. You can see the mean of this season (y) is greater than the mean of last season (x).
