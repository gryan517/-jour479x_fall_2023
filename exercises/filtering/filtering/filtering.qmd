...
#I wrote less than 100 with the logic that when there are less shots made with the most accuracy that's an efficient player. Especially being that the 1st quart is 101. 
```
